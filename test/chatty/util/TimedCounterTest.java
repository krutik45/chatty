...
public class TimedCounterTest {
    ...
    public void testGetCount() {
        ...
        TimedCounter timedCounterMock = mock(TimedCounter.class);

        TimedCounter timedCounter = new TimedCounter(120000);

        // Increase the count a few times
        timedCounter.increase();
        timedCounter.increase();
        timedCounter.increase();

        // Check the count without removing old elements
        int countWithoutRemove = timedCounter.getCount(false);
        ...
        int countWithRemove = timedCounter.getCount(true);
    ...
    public void testIncrease() {
        ...
        int initialCount = timedCounter.getCount();
        ...
        int countAfterIncrease = timedCounter.getCount();
